...
sudo R --no-save << EOF
install.packages(c('RJSONIO', 'itertools', 'digest', 'Rcpp', 'functional', 'httr', 'plyr', 'stringr', 'reshape2', 'caTools', 'rJava', 'devtools', 'DBI', 'ggplot2', 'dplyr','tidyr','readr','ggthemes','R.methodsS3','data.table', 'Hmisc', 'memoise', 'rjson'),
