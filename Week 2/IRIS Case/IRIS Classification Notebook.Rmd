...
To understand the visualization techniques, best practices and how to build plots with ggplot using the Grammar of Graphics ideas, refer the link below which is an excellent tutorial on [Visualization](http://socviz.co/index.html#preface) 
...
In the next chart we use a `boxplot` geomand summarize the statistic `mean` to display it on top the box plot.
