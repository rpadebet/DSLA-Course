...
# 2017-07-28 - Rohit rohit.pittu@gmail.com, added code to download the entire flights data
...
sudo R --no-save << EOF
install.packages(c('RJSONIO', 'itertools', 'digest', 'Rcpp', 'functional', 'httr', 'plyr', 'stringr', 'reshape2', 'caTools', 'rJava', 'devtools', 'DBI', 'ggplot2', 'dplyr','rparkling','tidyr','RPostgresSQL','RMySQL','readr','ggthemes','h2o','R.methodsS3', 'Hmisc', 'memoise', 'rjson'),
...
# Download the whole flights data
mkdir /tmp/flights

# Begin  Download the data
